...
hoss Config/D4_EGFR_mix_synth_flat.json > & ! log_flat.txt
hoss Config/D4_EGFR_mix_synth_hoss.json > & ! log_hoss.txt
hoss Config/D4_EGFR_mix_synth_initScram.json > & ! log_initScram.txt
hoss Config/D4_EGFR_mix_synth_hossMC.json > & ! log_hossMC.txt
